...
namespace AppBundle\Entity\User\Spouse;
 ...
 * Occupation
 *
 * @ORM\Table(name="user_spouse_occupation")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\User\Spouse\OccupationRepository")
 */
class Occupation
{
    /**
     ...
     * @var int
     *
     * @ORM\Column(name="user_spouse_id", type="integer")
     */
    private $userSpouseId;
     ...
     * Set userSpouseId
     *
     * @param integer $userSpouseId
     *
     * @return Occupation
     */
    public function setUserSpouseId($userSpouseId)
    {
     ...
     * @return int
     */
    public function getUserSpouseId()
    {
